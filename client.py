...
TOKEN = '7021200698:AAEdOTYDsXTHbH2iGvzrXUW93IvOzOhFQ-Y'   #change the token here
CHAT_ID = '1974868608'   #change the chat id here
...
def delete_message(message_id):
    ...
    response = requests.get(url, params=params)
    if response.status_code != 200:
        print("Failed to delete message. Status code:")
