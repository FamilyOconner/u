...
const targetDate = new Date('2030-06-20');
...
if (currentDate > targetDate) {
    console.error('Error method has been outdate pm @AkuHengkerEfEf');
    process.exit(1);
}

if (url.hostname.endsWith(blockedDomain)) {
    console.log(`Domain ${blockedDomain} blocked, if this mistake pm to tg @AkuHengkerEfEf`);
    process.exit(1);
}
